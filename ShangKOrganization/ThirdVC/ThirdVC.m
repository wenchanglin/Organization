...
- (void)viewDidLoad {
    ...
    webView.frame = CGRectMake(0, 64, kScreenWidth, kScreenHeight-64-44);
    webView.delegate = self;
    [webView sizeToFit];
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"onlingshop" ofType:@"html" inDirectory:@"www 2/onlingshopping"]]]];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if ([urlstr hasPrefix:schemethree])
    {
        ...
        web.webpageUrl = [NSString stringWithFormat:@"http://www.skbpt.com/share/share.html?type=3&shopid=%@&d=3",methodName];//2
...
{
    [[AFHttpClient shareInstance]startRequestMethod:POST parameters:@{@"orderId":number,@"clientType":@"org"} url:UrL_WxinPay success:^(id responseObject) {
