...
#define RONGCLOUD_IM_APPKEY @"ik1qhw091hubp"
...
@interface AppDelegate ()<WXApiDelegate,JPUSHRegisterDelegate,RCIMUserInfoDataSource,RCIMGroupInfoDataSource>
{
    ...
    NSString *_UserPhotoImage;
    NSString *_UserPhotoNickNAme;
}
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"恰巧%@",[defaults objectForKey:@"isLogin"]);
    [WXApi registerApp:@"wx80b9cb3eb8bdbb93" withDescription:@"ShangKeOrgzation"];
    [[UMSocialManager defaultManager] openLog:YES];
    //设置友盟appkey
    [[UMSocialManager defaultManager] setUmSocialAppkey:@"584a6774aed1793d65001638"];
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wx80b9cb3eb8bdbb93" appSecret:@"d64df5965e004193bc89ec659e583188" redirectURL:@"http://mobile.umeng.com/social"];
    //设置新浪的appKey和appSecret
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:@"2151258666"  appSecret:@"7822a33c69b29728e153b7bdfa7a6471" redirectURL:@"http://sns.whalecloud.com/sina2/callback"];
    if (![defaults boolForKey:@"Launch"] || ![[defaults objectForKey:@"isLogin"]isEqualToString:@"YES"]) {
        ...
        if ([defaults objectForKey:@"UserId"] == nil || [[defaults objectForKey:@"UserId"] isKindOfClass:[NSNull class]]) {
            [SVProgressHUD showErrorWithStatus:@"登录融云失败，请重新登录"];
        }else{
        //获取融云
...
//    [AMapServices sharedServices].apiKey = @"c6375c001facf8ec415c6b087ba4a364";
...
- (void)getGroupInfoWithGroupId:(NSString *)groupId completion:(void (^)(RCGroup *))completion
{
    ...
    [[AFHttpClient shareInstance]startRequestMethod:POST parameters:@{@"orgId":Manager.UUserId} url:UrL_MyOrgDetails success:^(id responseObject) {
        ...
        if ([rootTDic[@"userBase"][@"userPhotoHead"] isKindOfClass:[NSNull class]]) {
            ...
            _UserPhotoImage = rootTDic[@"userBase"][@"userPhotoHead"];
        }
        if ([rootTDic[@"userBase"][@"nickName"] isKindOfClass:[NSNull class]]) {
            
        }else{
            _UserPhotoNickNAme = rootTDic[@"userBase"][@"nickName"];
        }
        
        if ([groupId isEqualToString:Manager.UUserId]) {
            return completion([[RCGroup alloc]initWithGroupId:groupId groupName:_UserPhotoNickNAme portraitUri:[NSString stringWithFormat:@"%@%@",BASEURL,_UserPhotoImage]]);
        }else
        {
...
//    NSDictionary *params = @{@"studentId":userid};
//    [Tools posturl:Personal_information_url params:params sucess:^(id responseObject) {
//        if([responseObject[@"data"][@"userBase"][@"userPhotoHead"] isKindOfClass:[NSNull class]]  || responseObject[@"data"][@"userBase"][@"userPhotoHead"] == nil)
//        {
//            
//        }
//        else
//        {
//            _url = [Testserver stringByAppendingString:responseObject[@"data"][@"userBase"][@"userPhotoHead"]];
//        }
//        if ([userId isEqualToString:userid]) {
//            return completion([[RCUserInfo alloc] initWithUserId:userId name:@"name" portrait:_url]);
//        }else
//        {
//            return completion([[RCUserInfo alloc] initWithUserId:userId name:@"name" portrait:@"http://pic32.nipic.com/20130827/12906030_123121414000_2.png"]);
//        }
...
//    //advertisingId
//    [JPUSHService setupWithOption:launchOptions appKey:@"d593e0d46ce9ec0ee7ede3be"
//                          channel:@"App Store"
