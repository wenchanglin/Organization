...
///Users/apple/Desktop/ShangKOrganization/ShangKOrganization/ShangKeOrganization.pch
...
//http://192.168.3.158:10000/skl/  //http://lupin1084.6655.la
#define BASEURL @"http://139.196.233.19:8080/skl/"//http://192.168.3.234:8080/skl/
//http://139.196.233.19:8080/skl///http://139.196.233.19:8080/skl/
#define UrL_MACRO(p) [NSString stringWithFormat:@"%@%@",BASEURL,p]

#define UrL_SendYanZhengMa           UrL_MACRO(@"sms/sendPhoneValidCode")//验证码
#define UrL_Login                    UrL_MACRO(@"user/login")//登录
#define UrL_ChuangJian               UrL_MACRO(@"org/registerOrg")//创建
#define UrL_WanShanUserInfo          UrL_MACRO(@"org/perfectOrg")//完善信息
#define UrL_NewPassWord              UrL_MACRO(@"user/changePassword")//修改密码
#define UrL_NewPhonePassWord         UrL_MACRO(@"user/changePasswordByPhone")//根据手机修改密码
#define UrL_AcTivityManager          UrL_MACRO(@"orgActivity/queryOrgActivityList")//活动管理
#define UrL_AcTivityXiangQ           UrL_MACRO(@"orgActivity/getActivityDetailById")//活动详情
#define UrL_AcTivityCourseList       UrL_MACRO(@"orgActivity/showActivityCourseList")//课程列表
#define UrL_CourseDetails            UrL_MACRO(@"course/queryCourseDetail")//课程详情
#define UrL_AddActivity              UrL_MACRO(@"orgActivity/addOrgActivity")//机构活动添加
#define UrL_AddTeacher               UrL_MACRO(@"teacher/addTeacher")//教师账号创建 有一个管理员密码参数待改
#define UrL_UploadFile               UrL_MACRO(@"file/uploadFile")//文件上传
#define UrL_AddObject                UrL_MACRO(@"course/addCourse")//添加课程
#define UrL_TeacherCourse            UrL_MACRO(@"course/queryCoursesForTeacher")//教师负责课程列表
#define UrL_ObjectLieBiao            UrL_MACRO(@"course/queryCoursesForOrg")//课程列表
#define UrL_AddTeachAchienement      UrL_MACRO(@"orgTeachResult/queryOrgTeachResultListByOrgId")//教学成果列表
#define UrL_EveryAchienement         UrL_MACRO(@"orgTeachResult/getOrgTeachResultById")//教学成果详情
#define UrL_AddOrgTeachResult        UrL_MACRO(@"orgTeachResult/addOrgTeachResult")//添加第一行活动内容
#define UrL_AddOrgTeachResultItem    UrL_MACRO(@"orgTeachResult/addOrgTeachResultItem")//添加成果详情
#define UrL_AddOrgTeachUpdata        UrL_MACRO(@"orgTeachResult/updateOrgTeachResult")//修改成果详情
#define UrL_CourseOrder              UrL_MACRO(@"courseOrder/queryCourseOrdersForOrg")//我的订单列表
#define UrL_ListOfTeacher            UrL_MACRO(@"teacher/queryTeachersForOrg")//教师列表
#define UrL_FixOfTeacher             UrL_MACRO(@"teacher/modifyTeacherInfo")//修改教师信息
#define UrL_UpDownObject             UrL_MACRO(@"course/updateCourseStatus")//上下架课程
#define UrL_DeleteCourse             UrL_MACRO(@"course/deleteCourseForOrg")//删除课程
#define UrL_OverActivity             UrL_MACRO(@"orgActivity/removeOrgActivity")//机构活动结束
#define UrL_deleteActivity           UrL_MACRO(@"orgActivity/deleteOrgActivity")//机构活动删除
#define UrL_DeleteAchievent          UrL_MACRO(@"orgTeachResult/deleteOrgTeachResult")//删除教学成果活动
...
#define UrL_VideoPlay                UrL_MACRO(@"videoCourse/queryVideoCourseDetail")//播放视频
#define UrL_PlayVideoPlay            UrL_MACRO(@"videoCourse/playVideoCourse")//播放视频接口
#define UrL_PushMessage              UrL_MACRO(@"messageCenter/queryOrgNoticeListForOrg")//消息推送列表
#define UrL_EveryPushMessage         UrL_MACRO(@"messageCenter/queryOrgNoticeDetail")//推送详情
#define UrL_SendPushMessage          UrL_MACRO(@"messageCenter/sendOrgNotice")//发布推送
...
#define UrL_ChatGroupsQuery          UrL_MACRO(@"chat/queryMyChatGroupsForOrg")//群聊列表
...
#define UrL_AddShareCommon           UrL_MACRO(@"share/addShareCommon")//添加分享模板
...
#define UrL_ReportListOrg            UrL_MACRO(@"courseOrder/getReportListOrg")//报表课程分销
#define UrL_ReportListForOrg         UrL_MACRO(@"share/queryReportListForOrg")//活动分销奖励
#define UrL_queryStudentForOrg       UrL_MACRO(@"courseOrder/queryStudentForOrg")//报名学员统计
#define UrL_AddCompanyDetail         UrL_MACRO(@"org/addDetailIntroForOrg")//企业简介三段式
#define UrL_OrderDetails             UrL_MACRO(@"order/queryOrderDetail")//订单详情
#define UrL_OrderDelete              UrL_MACRO(@"order/deleteOrder")//订单删除
#define UrL_updateOrgInfo            UrL_MACRO(@"org/updateOrgManagerInfo")//修改个人信息
...
#define UrL_MyOrgDetails             UrL_MACRO(@"org/queryOrgDetailForManager")//机构详情
#define UrL_LookAllOrgDetail         UrL_MACRO(@"classify/queryOrgClassifyClassGroupsList")//查看机构全部业务
#define UrL_LookOrgDetail            UrL_MACRO(@"classify/queryOrgClassifyClassGroups")//查看机构业务
#define UrL_AddOrgDetail             UrL_MACRO(@"classify/addOrgClassifyOrgClass")//机构添加分类
#define UrL_ALiPayOrder              UrL_MACRO(@"alipay/payOrder")//订单支付宝支付
#define UrL_CourseStart              UrL_MACRO(@"courseOrder/updateStatusCourseStarted")//开始上课
...
#define UrL_TransferRecord           UrL_MACRO(@"useraccount/queryTransferAccountsOrderListForAccept")//转账记录
#define UrL_VideoPingLun             UrL_MACRO(@"videoCourse/addCourseComment")//视频添加评论
#define UrL_FindStudent              UrL_MACRO(@"user/queryUserForStudent")//课程详情搜索学员
#define UrL_LuRuStudent              UrL_MACRO(@"courseOrder/addOffOnline")//课程详情录入学员
#define UrL_QRShouHuo                UrL_MACRO(@"order/confirmReceive")//确认收货
#define UrL_OrderReturn              UrL_MACRO(@"order/storeResolveReturnGood")//订单商家处理
