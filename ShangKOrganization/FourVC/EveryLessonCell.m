...
-(void)createUI
{
    _mainScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0,0, kScreenWidth, kScreenHeight-(kScreenHeight/2+10)-200)];
...
{
    _FirstOneTitle.text =  Model.LessonBriefIntro;
    ...
    _SecondOneTitle.text = Model.LessonfitPeople;
