...
-(void)createData
{
    ...
    [[AFHttpClient shareInstance]startRequestMethod:POST parameters:@{@"userId":Manager.UUserId,@"type":@"messageTypeOrg",@"page":[NSString stringWithFormat:@"%ld",(long)_page]} url:UrL_SystemMessage success:^(id responseObject) {
        if (_isPulling) {
