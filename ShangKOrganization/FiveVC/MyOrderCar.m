...
-(void)createUI
{
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"shopcar" ofType:@"html" inDirectory:@"www 2/onlingshopping"]]]];
