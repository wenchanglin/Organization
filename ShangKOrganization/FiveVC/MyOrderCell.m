...
-(void)createUI
{
    ...
    _MiddleImage.image = [UIImage imageNamed:@"图层-56_37.png"];
...
-(void)configWithModel:(MyOrderModel *)Model
{
    ...
    if ([Model.MyOrderStoreGoodBasePhotoUrl isKindOfClass:[NSNull class]]) {
        _MiddleImage.image = [UIImage imageNamed:@"哭脸.png"];
    }else{
        [_MiddleImage setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BASEURL,Model.MyOrderStoreGoodBasePhotoUrl]] placeholderImage:nil];
    }
