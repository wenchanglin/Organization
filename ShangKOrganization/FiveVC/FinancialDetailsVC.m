...
-(void)createData
{
    ...
    [[AFHttpClient shareInstance]startRequestMethod:POST parameters:@{@"fkUserId":Manager.UUserId,@"page":[NSString stringWithFormat:@"%ld",(long)_page]} url:UrL_FinancialDetails success:^(id responseObject) {
