...
-(void)initMainScrollView
{
    ...
    BTn.frame           = CGRectMake(10, kScreenHeight/2+150, kScreenWidth-20, 50);
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag == 10) {
        ...
        if (!cell) {
            ...
            if (indexPath.row == 0 || indexPath.row == 2) {
             ...
             cell.textField.ex_heightToKeyboard = 0;
             cell.textField.ex_moveView = self.view;
    ...
    if (indexPath.section == 2) {
        ...
        cell.YHKtextField.ex_heightToKeyboard = 0;
        cell.YHKtextField.ex_moveView = self.view;
        ...
        [JianTouBtn setBackgroundImage:[UIImage imageNamed:@"56-拷贝@2x.png"] forState:UIControlStateNormal];
...
-(void)createTopView
{
    ...
    for (int i=0; i<2; i++) {
        ...
        UILabel *ZFLabel = [[UILabel alloc]initWithFrame:CGRectMake(i+112, 25, 60, 10)];
...
-(void)createNav
{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake((kScreenWidth - 50)/2, 10, 50, 30)];
    label.text = @"提现";
